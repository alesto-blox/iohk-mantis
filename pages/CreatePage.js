...
class CreatePage {
    ...
    get backButton() { return ('//span[text()="Back"]/..') }
    ...
    get conditionsLocallyBoxSpan() { return ('//input[@id="checkbox-local-only"]/../span') }
    ...
    get conditionRecoveryBoxSpan() { return ('//input[@id="checkbox-recovery"]/../span') }
    ...
    get errorMessagePhrases() { return ('//div[@class="error-message"]') }
    get reinputBox() { return ('//div[@class="InlineError input"]') }
